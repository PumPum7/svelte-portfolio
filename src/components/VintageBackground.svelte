<script lang="ts">
    ...
    background-image: radial-gradient(circle at center, transparent 0%, var(--color-parchment) 70%),
...
<div class="pointer-events-none fixed inset-0 z-0" style={backgroundStyle}></div>
